...
import frappe
from frappe.utils import today, add_months, add_days, add_years, now_datetime, flt
import random
import math
...
def _safe_insert(data, ignore_duplicate=True):
    """Insert a document, skipping if duplicate."""
    try:
        doc = frappe.get_doc(data)
        doc.insert(ignore_permissions=True, ignore_if_duplicate=ignore_duplicate)
        return doc.name
    except frappe.DuplicateEntryError:
        return frappe.db.get_value(data["doctype"], data.get("name") or data.get(data.get("doctype").lower().replace(" ", "_")))
    except Exception:
        return None
...
def load_foundation():
    ...
    rate_configs = [
        {"rate_name": "Personal Loan - Base", "loan_type": "Personal Loan", "base_rate": 10.99, "minimum_rate": 9.99, "maximum_rate": 24.00, "rate_type": "Fixed"},
        {"rate_name": "Home Loan - MCLR Linked", "loan_type": "Home Loan", "base_rate": 8.50, "minimum_rate": 7.50, "maximum_rate": 14.00, "rate_type": "Floating"},
        {"rate_name": "Gold Loan - Base", "loan_type": "Gold Loan", "base_rate": 7.50, "minimum_rate": 6.00, "maximum_rate": 18.00, "rate_type": "Reducing"},
        {"rate_name": "Business Loan - Base", "loan_type": "Business Loan", "base_rate": 12.50, "minimum_rate": 10.00, "maximum_rate": 22.00, "rate_type": "Floating"},
    ]
    for r in rate_configs:
        _safe_insert({
            "doctype": "Interest Rate Engine",
    ...
    # Charge Rules
    charges = [
        {"charge_name": "Processing Fee - Personal Loan", "charge_type": "Processing Fee", "percentage": 2.0, "applicable_on": "Personal Loan"},
        {"charge_name": "Prepayment Charges - Home Loan", "charge_type": "Prepayment Penalty", "percentage": 2.5, "applicable_on": "Home Loan"},
        {"charge_name": "Late Payment Penalty", "charge_type": "Late Payment", "percentage": 2.0, "applicable_on": "All Loans"},
        {"charge_name": "Statement Reprint Fee", "charge_type": "Service Fee", "amount": 100, "applicable_on": "All Loans"},
    ]
    for c in charges:
        _safe_insert({
            "doctype": "Charge Rule",
...
def load_customers():
    ...
    # Leads
    leads_data = [
        {"lead_name": "Rajesh Kumar", "company_name": "RK Enterprises", "mobile": "9876543210", "email": "rajesh@rkenterprises.com", "lead_status": "Converted", "source": "Website", "city": "Mumbai"},
        {"lead_name": "Priya Sharma", "company_name": "Priya's Boutique", "mobile": "9876543211", "email": "priya@boutique.com", "lead_status": "Converted", "source": "Reference", "city": "Delhi"},
        {"lead_name": "Amit Patel", "company_name": "Patel Constructions", "mobile": "9876543212", "email": "amit@patelcon.com", "lead_status": "Contacted", "source": "DSA", "city": "Bangalore"},
        {"lead_name": "Sunita Reddy", "company_name": "Reddy Associates", "mobile": "9876543213", "email": "sunita@reddyassoc.com", "lead_status": "New", "source": "Website", "city": "Hyderabad"},
        {"lead_name": "Vikram Singh", "mobile": "9876543214", "email": "vikram.singh@gmail.com", "lead_status": "Qualified", "source": "Facebook", "city": "Chennai"},
    ]
    for l in leads_data:
        _safe_insert({
            "doctype": "Lead",
    ...
    # DSA Masters
    dsas = [
        {"dsa_name": "FinPartners India", "contact_person": "Suresh Iyer", "contact_number": "9988776655", "commission_rate": 1.5, "city": "Mumbai", "status": "Active"},
        {"dsa_name": "LoanBazaar Associates", "contact_person": "Meena Joshi", "contact_number": "9988776656", "commission_rate": 2.0, "city": "Delhi", "status": "Active"},
    ]
    for d in dsas:
        _safe_insert({
            "doctype": "DSA Master",
            "naming_series": "DSA-.YYYY.-.####",
            **d
        })
    ...
    # Bizaxl Customers
    customers_data = [
        {"customer_name": "Rajesh Kumar", "customer_type": "Sole Proprietor", "mobile": "9876543210", "email": "rajesh@rkenterprises.com",
         "pan_number": "ABCDE1234F", "aadhaar_number": "123456789012", "ckyc_number": "CKYC100001",
         "kyc_status": "Verified", "risk_profile": "Medium", "annual_income": 1200000,
         "city": "Mumbai", "state": "Maharashtra", "employment_type": "Self-Employed"},
        {"customer_name": "Priya Sharma", "customer_type": "Individual", "mobile": "9876543211", "email": "priya@boutique.com",
         "pan_number": "FGHIJ5678K", "aadhaar_number": "234567890123", "ckyc_number": "CKYC100002",
         "kyc_status": "Verified", "risk_profile": "Low", "annual_income": 850000,
         "city": "Delhi", "state": "Delhi", "employment_type": "Business Owner"},
        {"customer_name": "Vikram Singh", "customer_type": "Individual", "mobile": "9876543214", "email": "vikram.singh@gmail.com",
         "pan_number": "KLMNO9012P", "aadhaar_number": "345678901234", "ckyc_number": "CKYC100003",
         "kyc_status": "Under Review", "risk_profile": "Low", "annual_income": 600000,
         "city": "Chennai", "state": "Tamil Nadu", "employment_type": "Salaried"},
        ...
        {"customer_name": "Lakshmi Narayanan", "customer_type": "Individual", "mobile": "9876543217", "email": "lakshmi.n@gmail.com",
         "pan_number": "ZABCD1234E", "aadhaar_number": "678901234567", "ckyc_number": "CKYC100006",
         "kyc_status": "Verified", "risk_profile": "Medium", "annual_income": 2400000,
         "city": "Chennai", "state": "Tamil Nadu", "employment_type": "Salaried"},
    ]
    for c in customers_data:
        _safe_insert({
            ...
            "is_verified": 1 if c["kyc_status"] == "Verified" else 0,
        })
    ...
    for cust_name in ["Rajesh Kumar", "Priya Sharma", "Vikram Singh"]:
        ...
        if cust:
            _safe_insert({
                "doctype": "Customer Nomination",
                "customer": cust,
                "nominee_name": f"Nominee of {cust_name}",
                "relationship": "Spouse",
                "nominee_date_of_birth": "1985-06-15",
    ...
    for cust_name in ["Rajesh Kumar", "Priya Sharma", "Ananya Desai"]:
        ...
        if cust:
            _safe_insert({
                ...
                "document_number": f"KYC-{random.randint(1000,9999)}",
                "document_status": "Verified",
                "verification_date": add_days(today(), -_rand_int(30, 180)),
            })
    ...
    for cust in customers[:4]:
        for _ in range(random.randint(5, 10)):
            ...
            _safe_insert({
                ...
                "transaction_category": random.choice(txn_cats),
                "amount": _rand_amount(500, 50000),
                "transaction_date": add_days(today(), -_rand_int(1, 90)),
                "status": "Completed",
...
def load_loans():
    ...
    # Loan Products
    products = [
        {"loan_product_name": "Personal Loan - Standard", "loan_type": "Personal Loan", "interest_rate": 10.99,
         "processing_fee": 2.0, "min_amount": 50000, "max_amount": 2500000, "min_tenure_months": 6, "max_tenure_months": 60},
        {"loan_product_name": "Home Loan - DreamHome", "loan_type": "Home Loan", "interest_rate": 8.50,
         "processing_fee": 1.5, "min_amount": 500000, "max_amount": 10000000, "min_tenure_months": 12, "max_tenure_months": 360},
        {"loan_product_name": "Gold Loan - Swarna", "loan_type": "Gold Loan", "interest_rate": 7.50,
         "processing_fee": 0.5, "min_amount": 10000, "max_amount": 1000000, "min_tenure_months": 3, "max_tenure_months": 24},
        {"loan_product_name": "Business Loan - Vyapar", "loan_type": "Business Loan", "interest_rate": 12.50,
         "processing_fee": 2.5, "min_amount": 200000, "max_amount": 5000000, "min_tenure_months": 12, "max_tenure_months": 84},
        {"loan_product_name": "Education Loan - Vidya", "loan_type": "Education Loan", "interest_rate": 9.50,
         "processing_fee": 1.0, "min_amount": 100000, "max_amount": 2000000, "min_tenure_months": 12, "max_tenure_months": 180},
        {"loan_product_name": "Vehicle Loan - DriveEasy", "loan_type": "Auto Loan", "interest_rate": 9.00,
         "processing_fee": 1.5, "min_amount": 100000, "max_amount": 3000000, "min_tenure_months": 12, "max_tenure_months": 84},
    ]
    for p in products:
        _safe_insert({
    ...
    for i, cust in enumerate(customers[:6]):
        ...
        loan_app = _safe_insert({
            ...
            "loan_product": product["loan_product_name"],
            "loan_amount": amount,
        ...
        if loan_app and status == "Disbursed":
            ...
            if disb:
                ...
                _safe_insert({
                    ...
                    "total_emis": tenure,
                    "remaining_emis": _rand_int(1, tenure),
                    "emi_amount": round(amount * (rate / 12 / 100) * math.pow(1 + rate/12/100, tenure) / (math.pow(1 + rate/12/100, tenure) - 1), 2) if rate > 0 else round(amount/tenure, 2),
                    "disbursement_date": add_days(today(), -_rand_int(15, 90)),
                ...
                for emi_num in range(1, min(4, _rand_int(1, 6))):
                    _safe_insert({
                        ...
                        "payment_mode": random.choice(["NACH Auto-Debit", "UPI", "NEFT"]),
                        "status": "Completed",
                    })
    ...
    for la in frappe.get_all("Loan Application", fields=["name", "customer_name", "loan_amount", "interest_rate", "tenure_months"]):
        _safe_insert({
            ...
            "loan_application": la.name,
            "customer_name": la.customer_name,
            "sanctioned_amount": la.loan_amount,
            "interest_rate": la.interest_rate,
            "tenure_months": la.tenure_months,
            "sanction_date": add_days(today(), -_rand_int(30, 120)),
            "status": "Accepted",
        })
    ...
    committee_decisions = [
        {"loan_application": la.name, "decision": "Approved", "decision_date": add_days(today(), -_rand_int(20, 60))}
        for la in frappe.get_all("Loan Application", fields=["name"])[:4]
    ]
    for cd in committee_decisions:
        _safe_insert({
            "doctype": "Credit Committee Decision",
            "naming_series": "CCD-.YYYY.-.####",
            **cd
        })
...
def load_insurance():
    ...
    for cust in customers[:4]:
        policy = _safe_insert({
            ...
            "sum_assured": _rand_amount(100000, 10000000),
            "premium_amount": _rand_amount(5000, 50000),
            "start_date": add_days(today(), -_rand_int(100, 365)),
            "expiry_date": add_months(today(), _rand_int(6, 12)),
            "status": "Active",
        })
        if policy:
            # Premium Payment
...
def load_investments():
    ...
    for cust in customers[:4]:
        _safe_insert({
            ...
            "depository": random.choice(["NSDL", "CDSL"]),
            "status": "Active",
        })
    ...
    for cust in customers[:3]:
        _safe_insert({
            ...
            "customer": cust.name,
            "deposit_amount": _rand_amount(50000, 500000),
            "interest_rate": _rand_amount(5.5, 7.5),
            "tenure_months": _rand_int(6, 60),
            "deposit_date": add_days(today(), -_rand_int(30, 365)),
            "maturity_date": add_months(today(), _rand_int(1, 12)),
            "status": "Active",
        })
...
def load_portfolio():
    ...
    # Asset Classes
    asset_classes = ["Equity", "Debt", "Gold", "Real Estate", "Cash", "Alternative Investments"]
    ...
    for cust in customers[:4]:
        for _ in range(random.randint(2, 4)):
            _safe_insert({
                "doctype": "Portfolio Holding",
                "customer": cust.name,
                "asset_class": random.choice(asset_classes),
                "holding_name": f"Demo {random.choice(['Stock','Fund','Bond'])} {random.randint(1,100)}",
                "invested_amount": _rand_amount(10000, 500000),
                "current_value": _rand_amount(10000, 500000),
                "quantity": _rand_int(10, 1000),
                "purchase_date": add_days(today(), -_rand_int(30, 365)),
            })
    ...
    for cust in customers[:3]:
        _safe_insert({
            "doctype": "Financial Goal",
            "customer": cust.name,
            "goal_name": random.choice(["Buy a House", "World Trip", "Early Retirement", "Startup Fund"]),
            "target_amount": _rand_amount(1000000, 10000000),
            "current_savings": _rand_amount(50000, 500000),
            "target_date": add_years(today(), random.randint(3, 20)),
            "goal_type": "Long Term",
        })
...
def load_gold_loan():
    ...
    # Auctioneer Register
    auctioneers_data = [
        {"auctioneer_name": "Mumbai Gold Auctions", "contact_person": "Ramesh Shah", "contact_number": "9988776601", "commission_percentage": 2.0, "specialization": "Gold", "city": "Mumbai", "status": "Active"},
        {"auctioneer_name": "Chennai Bullion House", "contact_person": "Karthik Iyer", "contact_number": "9988776602", "commission_percentage": 1.5, "specialization": "Gold", "city": "Chennai", "status": "Active"},
    ]
    for a in auctioneers_data:
        _safe_insert({
            "doctype": "Auctioneer Register",
            "naming_series": "AUCTNR-.YYYY.-.####",
            **a
        })
    ...
    for cust in customers[:4]:
        _safe_insert({
            "doctype": "Vault Register",
            "customer_name": cust.customer_name,
            "branch": "Head Office - Mumbai",
            "total_items": _rand_int(1, 5),
            "total_weight": _rand_amount(10, 100),
            "vault_location": f"Vault-{random.choice(['A','B','C'])}-{random.randint(1,50)}",
            "status": "Active",
        })
    ...
    for cust in customers[:3]:
        ...
        pledge = _safe_insert({
            "doctype": "Gold Pledge",
            "naming_series": "GP-.YYYY.-.####",
            "customer_name": cust.customer_name,
            "loan_amount": round(loan_amt, 2),
            "interest_rate": _rand_amount(6, 12),
            "tenure_months": _rand_int(6, 18),
            "interest_type": "Reducing",
            "total_gold_value": round(item_value, 2),
            "total_gross_weight": round(weight, 2),
            "total_net_weight": round(weight * 0.92, 2),
            "ltv_ratio": 75.00,
            ...
            "disbursed_amount": round(loan_amt, 2),
...
def load_vehicle_loan():
    print("\n🚗 VEHICLE LOAN MODULE")

    # Dealer Masters
    dealers = [
        {"dealer_name": "Mumbai Auto Centre", "city": "Mumbai", "contact_person": "Dinesh Joshi", "contact_number": "9988776631", "commission_rate": 2.0, "status": "Active"},
        {"dealer_name": "Chennai Car World", "city": "Chennai", "contact_person": "Suresh Babu", "contact_number": "9988776632", "commission_rate": 2.5, "status": "Active"},
    ]
    for d in dealers:
        _safe_insert({
            "doctype": "Dealer Master",
            "naming_series": "DLR-.YYYY.-.####",
            **d
        })
    ...
    for i, cust in enumerate(customers[:3]):
        ...
        _safe_insert({
            ...
            "rc_hypothecation_status": random.choice(["Pending", "Submitted to RTO", "Endorsed"]),
            "status": "Active",
        })
    ...
    for _ in range(2):
        _safe_insert({
            "doctype": "Vehicle Repossession",
            "naming_series": "REPO-.YYYY.-.####",
            "vehicle": frappe.get_all("Vehicle Detail", limit=1)[0].name if frappe.get_all("Vehicle Detail") else None,
            "customer_name": random.choice(["Default Borrower", "NPA Customer"]),
            "repossession_date": add_days(today(), -_rand_int(10, 60)),
            "repossession_reason": "NPA 90+ Days",
            "repossession_type": "Involuntary",
            "estimated_value": _rand_amount(200000, 800000),
            "recovery_cost": _rand_amount(10000, 50000),
...
def load_home_loan():
    ...
    for i, cust in enumerate(customers[:3]):
        prop = _safe_insert({
            ...
            "built_up_area": _rand_amount(800, 2500),
            "agreed_value": _rand_amount(3000000, 15000000),
            "market_value": _rand_amount(3000000, 15000000),
            "title_deed_number": f"TD-{random.randint(10000,99999)}",
            "legal_status": "Clear Title",
            "construction_stage": random.choice(["Completed", "Finishing", "Roof"]),
        })
    print("  ✅ Property Details created")

    # Tranche Disbursements
    for loan_app in frappe.get_all("Loan Application", filters={"loan_product": "Home Loan - DreamHome"}, limit=1):
        for stage_num, stage in enumerate(["Land Purchase", "Foundation", "Construction Stage 1", "Construction Stage 2", "Finishing"]):
            _safe_insert({
                "doctype": "Tranche Disbursement",
                "naming_series": "TR-.YYYY.-.####",
                "loan_application": loan_app.name,
                "tranche_number": stage_num + 1,
                "tranche_amount": _rand_amount(500000, 2000000),
                "tranche_purpose": stage,
    ...
    # PMAY Subsidies
    _safe_insert({
        "doctype": "PMAY Subsidy",
        "naming_series": "PMAY-.YYYY.-.####",
        "applicant_name": customers[0].customer_name if customers else "Demo Applicant",
        "income_category": "MIG-I (Rs.6L-12L)",
        "is_first_home": 1,
        "eligible_for_clss": 1,
        "subsidy_amount": 235000,
        "principal_reduction": 235000,
        "subsidy_status": "Eligibility Checked",
    })
    print("  ✅ PMAY Subsidies created")

    # Legal Opinions
    _safe_insert({
        "doctype": "Legal Opinion",
        "naming_series": "LEGAL-OP-.YYYY.-.####",
        "loan_application": frappe.get_all("Loan Application", limit=1)[0].name,
        "customer_name": customers[0].customer_name if customers else "Demo",
        "opinion_date": add_days(today(), -10),
        "advocate_name": "Adv. Rajesh Sharma",
        "title_clear": "Clear",
        "encumbrance_status": "Clear",
        "legal_opinion_status": "Favorable",
        "recommendation": "Approve",
    })
    print("  ✅ Legal Opinions created")

    # Engineer Certificates
    _safe_insert({
        "doctype": "Engineer Certificate",
        "naming_series": "ENG-CERT-.YYYY.-.####",
        "loan_application": frappe.get_all("Loan Application", limit=1)[0].name,
        "customer_name": customers[0].customer_name if customers else "Demo",
        "inspection_date": add_days(today(), -5),
        "engineer_name": "Er. Prakash Iyer",
        "current_stage": "Ground Floor",
        "percentage_complete": 45,
        "quality_check": "Good",
        "certified_stage": "Foundation",
        "stage_certified": 1,
        "certification_status": "Certified",
    })
    print("  ✅ Engineer Certificates created")


# ── 11. BUSINESS LOAN ───────────────────────────────────────────────────────────

def load_business_loan():
    print("\n💼 BUSINESS LOAN MODULE")

    customers = frappe.get_all("Bizaxl Customer", fields=["name", "customer_name"])
    for cust in customers[:3]:
        _safe_insert({
            "doctype": "Business Profile",
            "naming_series": "BIZ-.YYYY.-.####",
            ...
            "net_profit": _rand_amount(200000, 5000000),
            "interest_expense": _rand_amount(50000, 500000),
            "depreciation": _rand_amount(50000, 300000),
            "loan_principal_repayment": _rand_amount(100000, 1000000),
        })
...
def load_education_loan():
    print("\n🎓 EDUCATION LOAN MODULE")

    # Institution Master
    institutions = [
        {"institution_name": "IIT Bombay", "institution_type": "University", "city": "Mumbai", "state": "Maharashtra", "recognition": "UGC/AICTE", "naac_grade": "A++"},
        {"institution_name": "IIM Ahmedabad", "institution_type": "Management School", "city": "Ahmedabad", "state": "Gujarat", "recognition": "AICTE", "naac_grade": "A+"},
        {"institution_name": "Christian Medical College", "institution_type": "Medical College", "city": "Vellore", "state": "Tamil Nadu", "recognition": "MCI", "naac_grade": "A"},
    ]
    for inst in institutions:
        _safe_insert({
            "doctype": "Institution Master",
            "naming_series": "INST-.YYYY.-.####",
            **inst
        })
    ...
    for inst in frappe.get_all("Institution Master", limit=2):
        _safe_insert({
            "doctype": "Course Detail",
            "course_name": random.choice(["B.Tech Computer Science", "MBA Finance", "MD General Medicine", "B.Sc Nursing"]),
            "institution": inst.name,
            "course_duration_months": _rand_int(24, 60),
...
def load_bnpl():
    ...
    for cust in customers:
        ...
        bnpl_limit = _safe_insert({
            "doctype": "BNPL Limit",
            "naming_series": "BNPL-LMT-.YYYY.-.####",
            "customer_name": cust.customer_name,
            "credit_limit": limit_amount,
            "used_amount": _rand_amount(0, limit_amount * 0.6),
            "available_limit": limit_amount * 0.4,
            "interest_rate": 24.0,
            "status": "Active",
        })
        if bnpl_limit:
            for _ in range(random.randint(1, 3)):
                txn_amt = _rand_amount(1000, 25000)
                _safe_insert({
                    "doctype": "BNPL Transaction",
                    "naming_series": "BNPL-TXN-.YYYY.-.####",
...
def load_invoice_finance():
    ...
    for a in anchors:
        _safe_insert({
            "doctype": "Anchor Master",
            "naming_series": "ANCH-.YYYY.-.####",
            **a
        })
    ...
    for cust in customers:
        ...
        _safe_insert({
            "doctype": "Invoice Finance",
            "naming_series": "INV-.YYYY.-.####",
            "anchor": frappe.get_all("Anchor Master", limit=1)[0].name if frappe.get_all("Anchor Master") else None,
            "supplier_name": cust.customer_name,
            ...
            "disbursement_date": add_days(today(), -_rand_int(5, 30)),
            "disbursed_amount": round(amount * 0.85, 2),
            "due_date": add_days(today(), _rand_int(15, 90)),
        })
...
def load_chit_fund():
    ...
    for group_num in range(1, 4):
        ...
        group = _safe_insert({
            "doctype": "Chit Group",
            "naming_series": "CHIT-GRP-.YYYY.-.####",
            "chit_value": round(value, 2),
            "number_of_members": members,
            "monthly_subscription": round(value / members, 2),
            "duration_months": members,
            "foreman_commission": 5.0,
            "foreman_commission_amount": round(value * 0.05, 2),
            "start_date": add_months(today(), -_rand_int(1, 6)),
            "expected_end_date": add_months(today(), _rand_int(members - 6, members)),
            "status": "Active",
            "remarks": f"{members} member chit group #{group_num}",
        })
    ...
    for cg in chit_groups:
        ...
        for i, cust in enumerate(customers[:min(5, int(group.number_of_members))]):
            _safe_insert({
                "doctype": "Chit Subscriber",
                "chit_group": cg.name,
                "subscriber_name": cust.customer_name,
                "subscriber_type": "Prized" if i == 0 else "Non-Prized",
                "subscription_amount": group.monthly_subscription,
                "total_paid": group.monthly_subscription * _rand_int(1, 4),
                "status": "Active",
            })
    ...
    for cg in chit_groups[:1]:
        for auction_no in range(1, 4):
            _safe_insert({
                "doctype": "Chit Auction",
                "naming_series": "CHIT-AUC-.YYYY.-.####",
                "chit_group": cg.name,
                "auction_number": auction_no,
                ...
                "bid_amount": _rand_amount(1000, 5000),
                "status": "Completed" if auction_no < 3 else "Scheduled",
            })
...
def load_consumer_finance():
    ...
    for cust in customers:
        _safe_insert({
            "doctype": "POS Transaction",
            "naming_series": "POS-.YYYY.-.####",
            "customer": cust.customer_name,
            "retailer": random.choice(retailers)["retailer_name"],
            "product_category": random.choice(["AC", "TV", "Laptop", "Mobile", "Furniture"]),
            "transaction_amount": _rand_amount(10000, 100000),
            "tenor_months": random.choice([3, 6, 9, 12]),
            "transaction_date": add_days(today(), -_rand_int(1, 60)),
            "status": "Active",
        })
...
def load_collections():
    ...
    for cust in customers:
        _safe_insert({
            "doctype": "NACH Mandate",
            "naming_series": "NACH-.YYYY.-.####",
            "customer": cust.name,
            "customer_name": cust.customer_name,
            "mandate_type": "Physical",
            ...
            "end_date": add_months(today(), _rand_int(6, 36)),
            "status": "Active",
        })
    ...
    for la in loan_apps:
        _safe_insert({
            "doctype": "Collection Record",
            "naming_series": "CL-.YYYY.-.####",
            "loan_application": la.name,
            "customer_name": la.customer_name,
            ...
            "status": "Collected",
            "collection_officer": "Administrator",
        })

    # NPA Classifications
    for la in loan_apps[:2]:
        _safe_insert({
            "doctype": "NPA Classification",
            "naming_series": "NPA-.YYYY.-.####",
            "loan_application": la.name,
            "customer_name": la.customer_name,
            "npa_category": random.choice(["SMA-1", "SMA-2", "Sub-Standard"]),
            "outstanding_amount": _rand_amount(50000, 500000),
            "overdue_days": _rand_int(30, 180),
            "provision_percentage": random.choice([10, 15, 25, 40]),
            "classification_date": add_days(today(), -_rand_int(1, 30)),
            "status": "Active",
        })
    ...
    for la in loan_apps[:1]:
        _safe_insert({
            "doctype": "SARFAESI Case",
            "naming_series": "SARF-.YYYY.-.####",
            "loan_application": la.name,
            "customer_name": la.customer_name,
            "notice_date": add_days(today(), -_rand_int(30, 60)),
            "possession_date": add_days(today(), -_rand_int(10, 20)),
            "case_stage": "Notice Issued",
            "property_details": "Demo property under SARFAESI action",
            "status": "Active",
        })
...
def load_risk_compliance():
    ...
    # Regulatory Reports
    report_types = ["CRILC", "FPC Report", "PSL Report"]
    for rt in report_types:
        _safe_insert({
            "doctype": "Regulatory Report",
            "naming_series": "REGREP-.YYYY.-.####",
            "report_name": f"{rt} - {add_months(today(), -1)}",
            "report_type": rt,
...
def load_accounting():
    ...
    for branch in frappe.get_all("Branch Master", limit=3):
        _safe_insert({
            "doctype": "Fund Account",
            "naming_series": "FA-.YYYY.-.####",
            "branch": branch.name,
            "fund_name": f"Disbursement Fund - {branch.name}",
            "fund_type": "Disbursement",
            "current_balance": _rand_amount(1000000, 10000000),
            "currency": "INR",
        })

    # Co-lending Partnerships
    _safe_insert({
        "doctype": "Co-lending Partnership",
        "partner_name": "State Bank of India",
        "partner_type": "Bank",
        "partnership_date": add_days(today(), -_rand_int(30, 180)),
        "co_lending_ratio": 80.0,
        "status": "Active",
    })
    print("  ✅ Accounting data created")


# ── 20. CREDIT MANAGEMENT + OTHERS ──────────────────────────────────────────────

def load_credit_mgmt():
    ...
    for cust in customers:
        _safe_insert({
            ...
            "credit_score": _rand_int(600, 850),
            "report_date": add_days(today(), -_rand_int(10, 60)),
            "total_accounts": _rand_int(2, 10),
            "active_loans": _rand_int(0, 4),
            "status": "Fetched",
        })
        ...
        _safe_insert({
            ...
            "bureau": "CIBIL",
            "credit_score": _rand_int(600, 850),
            "score_date": add_months(today(), -_rand_int(1, 6)),
        })

        _safe_insert({
            "doctype": "Credit Goal",
            "customer": cust.name,
            "target_score": _rand_int(750, 850),
            "current_score": _rand_int(600, 750),
            "target_date": add_years(today(), 1),
...
def load_microfinance():
    print("\n🤝 MICROFINANCE MODULE")
    centers_names = ["Koramangala Center", "Indiranagar Center", "Whitefield Center", "JP Nagar Center"]
    for cn in centers_names[:3]:
        center = _safe_insert({
            "doctype": "MFI Center",
            "naming_series": "MFI-C-.YYYY.-.####",
            "center_name": cn,
        ...
        if center:
            group = _safe_insert({
                "doctype": "JLG Group",
                "naming_series": "JLG-.YYYY.-.####",
                "group_name": f"Group of {cn}",
                "center": center,
                "formation_date": add_months(today(), -_rand_int(3, 12)),
                "group_leader": "Demo Leader",
                "status": "Active",
            })
            if group:
                member_names = ["Lakshmi", "Radha", "Geetha", "Sarala", "Meena"]
                for mn in member_names[:3]:
                    _safe_insert({
                        "doctype": "MFI Member",
                        "naming_series": "MFI-M-.YYYY.-.####",
                        "member_name": mn,
                        "jlg_group": group,
                        "center": center,
                        ...
                        "outstanding_amount": _rand_amount(1000, 40000),
                        "status": "Active",
                    })
...
def load_nbfc():
    ...
    for cust in customers:
        _safe_insert({
            "doctype": "NBFC Loan Application",
            "naming_series": "NBFC-LA-.YYYY.-.####",
            "customer": cust.name,
            "customer_name": cust.customer_name,
            "loan_amount": _rand_amount(1000000, 10000000),
            "interest_rate": _rand_amount(10, 18),
            "tenure_months": _rand_int(12, 60),
            "status": "Under Review",
...
# ── Integration Settings (Single) ───────────────────────────────────────────────

def load_integration_settings():
    print("\n🔌 INTEGRATION SETTINGS")
    try:
        frappe.db.set_single_value("Integration Settings", "uidai_endpoint", "https://api.uidai.gov.in/ekyc/v2")
        frappe.db.set_single_value("Integration Settings", "pan_endpoint", "https://pan.NSDL.co.in/api/verify")
        frappe.db.set_single_value("Integration Settings", "bureau_endpoint", "https://api.cibil.com/v2/report")
        frappe.db.set_single_value("Integration Settings", "aa_endpoint", "https://api.sahamati.org.in/v1")
        frappe.db.set_single_value("Integration Settings", "esign_endpoint", "https://esign.cca.gov.in/api")
        frappe.db.set_single_value("Integration Settings", "npci_api_endpoint", "https://api.npci.org.in/v2")
        frappe.db.set_single_value("Integration Settings", "smsgateway_endpoint", "https://api.msg91.com/api/v5")
        frappe.db.set_single_value("Integration Settings", "scorecard_enabled", 0)
        print("  ✅ Integration Settings configured")
    except Exception as e:
        print(f"  ⚠️ Integration Settings: {str(e)}")
...
def load_payments():
    print("\n💳 PAYMENTS MODULE")
    categories = ["Electricity", "Water", "Gas", "DTH", "Broadband", "Insurance Premium", "Loan Repayment", "Credit Card"]
    for cat in categories:
        _safe_insert({
            "doctype": "Bill Payment Category",
            "category_name": cat,
            "description": f"Bill payments for {cat}",
            "is_active": 1,
        })
    providers = [
        {"provider_name": "Tata Power", "provider_type": "Electricity", "is_active": 1},
        {"provider_name": "Mumbai Water Board", "provider_type": "Water", "is_active": 1},
        {"provider_name": "Mahanagar Gas", "provider_type": "Gas", "is_active": 1},
        {"provider_name": "Tata Sky", "provider_type": "DTH", "is_active": 1},
        {"provider_name": "Jio Fiber", "provider_type": "Broadband", "is_active": 1},
    ]
    for pr in providers:
        _safe_insert({
            "doctype": "Recharge Provider",
            **pr
        })
    print("  ✅ Payment categories + providers created")
...
def load_demo_data():
    ...
    load_education_loan()
    load_bnpl()
    load_invoice_finance()
    load_chit_fund()
    load_consumer_finance()
    load_collections()
    load_risk_compliance()
    load_accounting()
